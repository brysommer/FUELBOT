...
`,
            ...
            return bot.sendMessage(
                chatId,
                'Перешліть фото одометра та чеку. Натисніть на іконку "скріпка", оберіть зображення з галереї і відправте в діалог з ботом. Фото буде переслано адміністратору.',
                {
                    reply_markup: {
                        keyboard: [[{ text: 'Головне меню 🏠' }]],
                        resize_keyboard: true,
